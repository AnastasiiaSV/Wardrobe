<?php
    return [
        ...
        'account_info' => 'Информация аккаунта',
        'name' => 'Имя',
        'surname' => 'Фамилия',
        'phone' => 'Телефон',
        ...
        'crop' => 'Обрезать и перейти к следующему шагу',
        ...
        'select_for_chosen' => 'выберете для соответствующего',
        'choose_for_given' => 'выберете для соответствующего',
        ...
        'email_info' => 'Вы не можете менять email.',
